const createNav = () => {
    ...
    <div class="nav-container">
        ...
        <div class="menu-container">
            <ul class="menu-nav">
                <li class="menu-item">
                    <a class="menu-link capitalize" href="/home" title="Home">
                        home
                    </a>
                </li>
                <li class="menu-item">
                    <a class="menu-link capitalize" href="/store" title="Negozio Online">
                        store
                    </a>
                </li>
                <li class="menu-item">
                    <a class="menu-link uppercase" href="/FAQ" title="Risposte a Domande Frequenti">
                        faq
                    </a>
                </li>
                <li class="menu-item">
                    <a class="menu-link capitalize" href="/contatti" title="Contatti">
                        contatti
                    </a>
                </li>
            </ul>
...
const createFooter = () => {
    ...
    <div class="footer-container">
        ...
        <div class="info-container">
            <ul class="info-list">
                <li>
                    <a href="/terms&conditions" class="info-link">
                        Terms & Conditions
                    </a>
                </li>
                <li>
...
const createComingSoon = () => {
    ...
    main.innerHTML = `
    <a class="link-product" href="/home">
